...
To answer this, let's see the column deeper by using `View()` function. We're not going to use `unique()` as we're sure it will produce incredibly long lines and that will crash our R markdown article.
